/**
 * @file startup_stm32f446xe.c
 * @author İsmail Enes Bilgin (i.enesbilgin@bilginier.com)
 * @brief 
 * @version 0.1
 * @date 2021-09-17
 * 
...
void OTG_HS_EP1_WKUP_Handler(void)                                  __attribute__ ((weak, alias ("Default_Handler")));
...
uint32_t vectors[] __attribute__((section (".isr_vector"))) = {
    ...
    (uint32_t) OTG_HS_EP1_WKUP_Handler,
